      ...
      },
      {
        ...
        depth: [
          ...
          },
          {
            ...
            answer: "Johan Jørgen Holst",
            explanation: "Johan Jørgen Holst provided the secluded, pressure-free environment in Norway absolutely essential for building personal trust.",
            year: 1993
          },
          {
            id: "q_3_3_d3",
...
const NARRATIVE_SKILLS_DATA = {
  ...
  "n2": {
    keywords: ["Gaza", "Czechoslovakia", "Aswan High Dam", "Suez Canal", "Protocol of SÃ¨vres"],
    ...
    correct: [2, 1, 0],
    model: "In early 1955, Israel launched a severe attack on the Egyptian army headquarters in Gaza. <span class='highlight-link'>This convinced</span> President Nasser that his military was weak and <span class='highlight-word'>provoked</span> him to sign a massive arms deal with Czechoslovakia to secure Soviet weapons. <span class='highlight-link'>As a result</span> of Egypt allying with the Soviet bloc, the USA and Britain decided to withdraw their financial support for Nasser's flagship project, the Aswan High Dam. <span class='highlight-link'>In retaliation</span>, Nasser nationalised the Suez Canal in July 1956 to use its toll revenues to build the dam. This action severely <span class='highlight-word'>deteriorated</span> relations and threatened British and French interests, <span class='highlight-link'>leading directly to</span> them holding secret meetings with Israel (the Protocol of Sèvres) to plan a joint military invasion of Egypt, which <span class='highlight-word'>escalated</span> into the Suez Crisis."
  },
  "n3": {
