    ...
    if (data.dualPerspective) {
      ...
      <div class="dual-perspective-card left-active"
        ...
        <div class="dual-perspective-slider-row">
          <span class="perspective-label label-left active">\u{1F1EE}\u{1F1F1} Israeli Perspective</span>
          <div class="slider-wrapper">
            <input type="range" class="perspective-range-slider" min="0" max="100" value="0">
          </div>
          <span class="perspective-label label-right">\u{1F1F5}\u{1F1F8}/\u{1F1EA}\u{1F1EC} Arab Perspective</span>
        </div>
