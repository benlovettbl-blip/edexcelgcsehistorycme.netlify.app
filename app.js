    ...
    "questions.js"(exports) {
      ...
      var NARRATIVE_SKILLS_DATA4 = {
        "n1": {
          ...
          correct: [1, 2, 0],
          model: "<strong>Initially</strong>, the road to war began in November 1947 when the United Nations passed Resolution 181, recommending the partition of the British Mandate of Palestine into separate Jewish and Arab states. <span class='highlight-link'>While Jewish leaders accepted</span> the plan, the Palestinian Arabs and neighbouring Arab states rejected it, viewing it as an illegal usurpation of their land. <span class='highlight-word'>Consequently</span>, this diplomatic dispute triggered an immediate civil war within Palestine as both communities fought for control of key towns and roads.<br><br><strong>Subsequently</strong>, as the British administration refused to intervene and prepared for its final withdrawal, the civil conflict intensified. Jewish paramilitary forces (the Haganah and Irgun) launched offensive operations to secure the territory allocated by the UN, including capturing key urban centers like Haifa and Jaffa. <span class='highlight-link'>This escalation provoked</span> a severe humanitarian crisis, causing tens of thousands of Palestinian Arabs to flee their homes in fear, while Arab volunteer forces entered Palestine to support the local population.<br><br><strong>Finally</strong>, the conflict escalated into a full-scale international war when the British Mandate officially expired on 14 May 1948, and David Ben-Gurion declared the creation of the State of Israel. <span class='highlight-link'>This declaration instantly provoked</span> an invasion by the regular armies of five neighboring Arab states (Egypt, Syria, Transjordan, Lebanon, and Iraq) the very next day. <span class='highlight-word'>Ultimately</span>, this invasion transformed the local civil conflict into the first Arab-Israeli War, shaping the political borders of the region for decades."
        },
        "n2": {
          ...
          correct: [2, 1, 0],
          model: "<strong>Initially</strong>, relations between Israel and Egypt were defined by the unresolved status of the 1948\u201349 war, with Egypt maintaining a state of belligerency and enforcing an economic blockade on Israeli shipping. In February 1955, Israel launched a severe attack on the Egyptian army headquarters in Gaza, killing 38 Egyptian soldiers. <span class='highlight-link'>This humiliating defeat exposed Egypt's military weakness</span>, <span class='highlight-word'>forcing</span> President Nasser to seek modern weaponry from the Soviet bloc, which led to the Czech Arms Deal in September 1955 and shattered the regional balance of power.<br><br><strong>Subsequently</strong>, as a result of Egypt allying with the Soviet bloc, the USA and Britain decided to withdraw their financial support for Nasser's flagship project, the Aswan High Dam. In retaliation, Nasser nationalised the Suez Canal in July 1956 to use its toll revenues to build the dam. <span class='highlight-link'>This nationalisation threatened British and French commercial interests</span>, prompting them to form a secret alliance with Israel.<br><br><strong>Finally</strong>, the secret Protocol of S\xE8vres was signed in October 1956 to plan a joint military response. Under the plan, Israel launched a pre-emptive invasion of Sinai, which provided a pretext for Britain and France to intervene. <span class='highlight-word'>Ultimately</span>, although the invading forces withdrew under US pressure, this Suez Crisis cemented a state of permanent cold war and established Nasser as a hero of Pan-Arabism."
        },
        "n3": {
          ...
          correct: [0, 2, 1],
          model: "<strong>Initially</strong>, the path to conflict began following the events of Black September in 1970, when the PLO was violently expelled from Jordan. Yasser Arafat and thousands of armed fighters relocated to Lebanon, taking advantage of the weak central government in Beirut. <span class='highlight-link'>This influx of militants enabled</span> the PLO to establish a powerful administrative and military enclave in southern Lebanon, which became known as 'Fatahland', effectively creating a 'state within a state' on Israel's northern border.<br><br><strong>Subsequently</strong>, the PLO used southern Lebanon as a base to launch frequent rocket attacks and cross-border raids into northern Israel, including the deadly 1978 Coastal Road Massacre. <span class='highlight-link'>These constant guerrilla attacks provoked</span> heavy Israeli military reprisal strikes, including the 1978 Operation Litani to push the PLO back. <span class='highlight-word'>Consequently</span>, despite the deployment of UN peacekeepers, the borders remained highly unstable as PLO infiltrations and rocket exchanges continued to threaten Israeli security.<br><br><strong>Finally</strong>, the crisis reached a breaking point in June 1982 when the attempted assassination of the Israeli ambassador in London by a Palestinian splinter group served as the final trigger. This event provided Defence Minister Ariel Sharon with the justification to launch 'Operation Peace for Galilee', a full-scale invasion of Lebanon that drove to Beirut. <span class='highlight-link'>This overwhelming military campaign forced</span> the PLO to evacuate their headquarters to Tunis, <span class='highlight-word'>resulting in</span> their military defeat and expulsion from Lebanon."
        },
        "n4": {
          ...
          correct: [0, 2, 1],
          model: "<strong>Initially</strong>, a major diplomatic shift occurred in 1988 when Yasser Arafat addressed the UN in Geneva, officially renouncing terrorism and accepting a two-state solution based on UN Resolution 242. <span class='highlight-link'>This moderate stance enabled</span> the United States to open a direct diplomatic dialogue with the PLO for the first time. <span class='highlight-word'>Consequently</span>, this dialogue broke the long-standing international isolation of the PLO, although direct talks between Israel and the PLO remained officially forbidden.<br><br><strong>Subsequently</strong>, the diplomatic pressure was intensified by the end of the Cold War and the 1991 Gulf War. The collapse of the Soviet Union stripped the PLO of its primary financial and military backer, while Arafat's support for Saddam Hussein during the Gulf War alienated wealthy Arab Gulf states, leaving the PLO financially bankrupt. <span class='highlight-link'>This severe isolation forced</span> Yasser Arafat to recognize that the PLO had to make major compromises to survive.<br><br><strong>Finally</strong>, the election of Yitzhak Rabin's labor government in 1992 brought a more pragmatic leadership to Israel, which recognized that military force could not halt the First Palestinian Intifada. <span class='highlight-link'>This mutual need for a solution led to</span> secret, back-channel negotiations in Oslo, Norway, in 1993. <span class='highlight-word'>Ultimately</span>, these negotiations resulted in the historic Oslo Accords (Oslo I), establishing mutual recognition and creating the Palestinian National Authority to grant limited self-rule."
        },
        "pn1": {
          ...
          correct: [0, 1, 2],
          model: "<strong>Initially</strong>, relations between Egypt and Israel were defined by deep hostility and military conflict when President Sadat launched a surprise offensive in October 1973, triggering the Yom Kippur War. <span class='highlight-link'>This sudden assault shattered</span> the status quo, and although Israel recovered militarily, the initial Arab successes restored Egyptian national pride and prestige. <span class='highlight-word'>Consequently</span>, this restoration of pride created a vital political space that made future diplomatic negotiations with Israel a realistic possibility for the Egyptian leadership.<br><br><strong>Subsequently</strong>, the high risk of a direct superpower conflict between the USA and the USSR <span class='highlight-word'>forced</span> the United States to intervene actively in regional diplomacy. US Secretary of State Henry Kissinger conducted intensive 'shuttle diplomacy' between Jerusalem and Cairo to defuse the immediate military crisis. <span class='highlight-link'>This diplomatic mediation resulted in</span> the signing of the Sinai I (1974) and Sinai II (1975) disengagement agreements, which separated the hostile forces, reopened the Suez Canal, and began a gradual normalization process.<br><br><strong>Finally</strong>, despite these incremental military agreements, a formal diplomatic peace treaty remained stalled, prompting President Sadat to take a revolutionary step to break the deadlock. In November 1977, Sadat made his historic visit to Jerusalem to address the Israeli Knesset directly. <span class='highlight-link'>This dramatic gesture broke</span> the long-standing psychological barrier and taboo of Arab non-recognition of Israel, directly <span class='highlight-word'>paving</span> the way for the Camp David negotiations and a permanent peace treaty."
        },
        "pn2": {
          ...
          correct: [0, 1, 2],
          model: "<strong>Initially</strong>, the Palestinian issue was escalated in September 1970 when the PFLP hijacked four international civilian aircraft and blew up three of them at Dawson's Field in Jordan. <span class='highlight-link'>This direct challenge</span> to Jordan's sovereignty and stability <span class='highlight-word'>provoked</span> King Hussein to launch a massive military offensive against the PLO, a conflict known as Black September. <span class='highlight-word'>Consequently</span>, this civil war ended in the total defeat and expulsion of the Palestinian forces from Jordan by July 1971.<br><br><strong>Subsequently</strong>, the expelled PLO fighters were forced to relocate their headquarters and establish a new base of operations in Lebanon. <span class='highlight-link'>Furious at their defeat</span> and displacement, extreme Palestinian militants formed the 'Black September' splinter group to execute high-profile international terrorist actions. <span class='highlight-link'>This culminated in</span> the hostage crisis at the Munich Olympics in September 1972, where the group seized and murdered 11 Israeli athletes.<br><br><strong>Finally</strong>, the Munich massacre shocked the international community as the crisis was broadcast live to 900 million viewers, forcing the unresolved Palestinian issue back onto the global stage. <span class='highlight-link'>The outrage generated by this attack prompted</span> Israel to launch 'Operation Wrath of God', a systematic covert assassination campaign to eliminate the planners of the Munich massacre. <span class='highlight-word'>Ultimately</span>, this cycle of violence hardened international attitudes toward the PLO, branding it as a terrorist organization and delaying diplomatic solutions."
        },
        "pn3": {
          ...
          correct: [0, 1, 2],
          model: "<strong>Initially</strong>, a major breakthrough occurred in early 1993 when Israeli and PLO representatives bypassed public stalemates to hold secret back-channel negotiations in Norway. <span class='highlight-link'>These meetings built</span> the mutual trust that <span class='highlight-word'>enabled</span> the signing of the Oslo I Accords in September 1993, where Yasser Arafat and Yitzhak Rabin shared a historic handshake. <span class='highlight-word'>Consequently</span>, this agreement established the Palestinian National Authority (PNA) to provide Palestinians with limited self-government in Gaza and Jericho.<br><br><strong>Subsequently</strong>, the peace process was expanded in September 1995 with the signing of the Oslo II Accord. <span class='highlight-link'>This agreement resulted in</span> dividing the West Bank into Areas A, B, and C with different levels of Palestinian and Israeli administrative and security control, aiming to gradually transfer more territory to the PNA. <span class='highlight-link'>However, these compromises provoked</span> severe domestic opposition from extremists on both sides, who felt their leaders had betrayed their core principles.<br><br><strong>Finally</strong>, the escalating tensions culminated in a severe blow to the negotiations when a right-wing Jewish extremist assassinated Israeli Prime Minister Yitzhak Rabin at a peace rally in November 1995. <span class='highlight-link'>Rabin's assassination removed</span> the key Israeli partner committed to the peace process, leading to political instability. <span class='highlight-word'>Ultimately</span>, this loss of leadership, combined with ongoing Hamas suicide bombings, halted the momentum of the peace talks and left key issues unresolved."
        },
        "pn4": {
          ...
          correct: [0, 1, 2],
          model: "<strong>Initially</strong>, in the immediate aftermath of the 1948\u201349 war, the newly established state of Israel faced the urgent task of defending and consolidating its borders. Under the armistice agreements of 1949, Israel captured 78% of former Palestine, significantly more territory than the UN partition plan had allocated. <span class='highlight-link'>However, these new borders</span> were long, poorly defined, and surrounded by hostile Arab nations, which <span class='highlight-word'>triggered</span> frequent cross-border infiltrations.<br><br><strong>Subsequently</strong>, to secure this fragile territory against hostile neighbors, Israel rapidly consolidated its military forces, formally establishing the Israeli Defence Forces (IDF) under a single command. To support this national defense and integrate the population, Israel passed the historic Law of Return in 1950, which granted any Jew in the world the right to claim immediate citizenship. <span class='highlight-link'>This policy resulted in</span> a massive wave of immigration, doubling Israel's population within three years.<br><br><strong>Finally</strong>, the arrival of hundreds of thousands of new citizens placed an overwhelming strain on the country's weak economy, forcing the government to implement a strict austerity regime (Tzena). <span class='highlight-link'>To house the families</span>, Israel constructed temporary tent camps and began the rapid development of new towns in rural areas. <span class='highlight-word'>Ultimately</span>, these developments provided the essential civilian and military manpower needed to rebuild the economy and secure peripheral borders, ensuring Israel's long-term survival."
        },
        "pn5": {
          ...
          correct: [0, 1, 2],
          model: "<strong>Initially</strong>, the PLO's presence in Lebanon was established after their violent expulsion from Jordan during the Black September conflict of 1970\u201371. Yasser Arafat and thousands of armed fighters relocated to Lebanon, taking advantage of the weak central government in Beirut. <span class='highlight-link'>This influx of militants enabled</span> the PLO to set up a powerful administrative and military base in southern Lebanon, which became known as 'Fatahland', effectively creating a 'state within a state'.<br><br><strong>Subsequently</strong>, from this new southern Lebanese base, the PLO launched frequent rocket attacks and cross-border raids into northern Israeli towns, including the deadly 1978 Coastal Road Massacre. <span class='highlight-link'>These constant guerrilla attacks provoked</span> heavy Israeli military reprisal strikes and destabilized Lebanon's fragile sectarian balance, contributing directly to the outbreak of the Lebanese Civil War. <span class='highlight-word'>Consequently</span>, Israel formed an alliance with Christian Lebanese militias to counter the growing power of the PLO and its Muslim allies.<br><br><strong>Finally</strong>, the escalation of border violence reached a breaking point in June 1982 when the attempted assassination of the Israeli ambassador in London was blamed on the PLO. In response, Israel launched a massive invasion, 'Operation Peace for Galilee', driving all the way to Beirut and placing the city under a devastating siege. <span class='highlight-link'>This overwhelming military pressure forced</span> Arafat and the PLO leadership to accept a US-brokered evacuation, <span class='highlight-word'>resulting in</span> their expulsion from Lebanon to Tunis and temporarily shattering the PLO's military capabilities."
        }
      };
      var PAST_PAPERS_DATA2 = [
        ...
        },
        {
          ...
          q2: {
            ...
            model: "<strong>Initially</strong>, the crisis was triggered in July 1956 when Egyptian President Gamal Abdel Nasser nationalised the Suez Canal Company, aiming to use its transit tolls to fund the construction of the Aswan High Dam. <span class='highlight-link'>This nationalisation outraged</span> Britain and France, who viewed the canal as a vital economic lifeline for their oil shipping and saw Nasser as a dangerous dictator. <span class='highlight-word'>Consequently</span>, the European powers resolved to reclaim control of the canal by force and secretly conspired with Israel to orchestrate a military invasion.<br><br><strong>Subsequently</strong>, under the secret Protocol of S\xE8vres, Israel launched a surprise land invasion of the Sinai Peninsula in late October 1956, driving Egyptian forces back toward the canal. <span class='highlight-link'>This planned attack provided</span> the pretext for Britain and France to intervene, sending troops to seize the canal zone under the guise of separating the combatants. <span class='highlight-link'>Although the combined forces quickly achieved</span> their military objectives, their actions provoked immediate global condemnation and escalated tensions between the superpowers.<br><br><strong>Finally</strong>, the invasion ended in political humiliation for the Western powers when US President Eisenhower exerted severe financial pressure by threatening to bankrupt the British economy. <span class='highlight-link'>This decisive economic intervention forced</span> a rapid ceasefire and the withdrawal of British and French troops, who were replaced by a UN Emergency Force (UNEF). <span class='highlight-word'>Ultimately</span>, this outcome consolidated Nasser's position as a legendary hero of Pan-Arabism and marked the end of Britain and France's status as global superpowers."
          },
          q3: {
            type: "importance_choice",
            question: "Explain two of the following: (16 marks)",
        ...
        },
        {
          ...
          q2: {
            ...
            model: "<strong>Initially</strong>, relations between Israel and Egypt were defined by the unresolved status of the 1948\u201349 war, with Egypt maintaining a state of belligerency and enforcing an economic blockade on Israeli shipping. In 1952, a nationalist coup led by the Free Officers resulted in the abdication of King Farouk of Egypt, which eventually brought Gamal Abdel Nasser to power. <span class='highlight-link'>Nasser's rise to power intensified hostilities</span>, as he actively supported cross-border Fedayeen guerrilla raids into Israel from the Egyptian-controlled Gaza Strip.<br><br><strong>Subsequently</strong>, Israel adopted an aggressive defense policy of disproportionate reprisal raids to deter these infiltrations. This cycle of violence culminated in a devastating Israeli military assault on an Egyptian military base in Gaza in February 1955, which killed 38 Egyptian soldiers. <span class='highlight-link'>This humiliating defeat exposed Egypt's military weakness</span>, <span class='highlight-word'>forcing</span> Nasser to seek modern weaponry from the Soviet bloc, which led to the Czech Arms Deal in September 1955 and shattered the regional balance of power.<br><br><strong>Finally</strong>, the escalating tensions peaked in July 1956 when Nasser nationalised the Suez Canal Company, aiming to use its transit tolls to fund the Aswan High Dam. <span class='highlight-link'>This nationalisation threatened British and French commercial interests</span>, prompting them to form a secret alliance with Israel at S\xE8vres. <span class='highlight-word'>Ultimately</span>, this collusion led to Israel's pre-emptive invasion of the Sinai Peninsula in October 1956, culminating in the Suez Crisis and cementing a state of permanent cold war."
          },
          q3: {
            type: "importance_choice",
            question: "Explain two of the following: (16 marks)",
        ...
        },
        {
          ...
          q2: {
            ...
            model: "<strong>Initially</strong>, tensions began to rise rapidly following the Cairo Conference of 1964, where Arab League leaders approved plans to divert the headwaters of the River Jordan to cut off Israel's water supply. In response, Israel launched air and artillery strikes to destroy the diversion works. <span class='highlight-link'>This water dispute was accompanied by</span> Syria providing active military support and training to Yasser Arafat's Fatah guerrilla group, enabling them to launch cross-border sabotage raids into Israel.<br><br><strong>Subsequently</strong>, the guerrilla raids led to a series of escalating border skirmishes and reprisal actions by the IDF. In November 1966, following a Fatah landmine attack that killed Israeli soldiers, the IDF launched a massive armored raid on the Jordanian-controlled West Bank village of Samu. <span class='highlight-link'>The destruction of Samu resulted in</span> severe humiliation for Jordan's King Hussein, sparking massive anti-government riots among West Bank Palestinians who demanded stronger action against Israel.<br><br><strong>Finally</strong>, the regional escalation peaked in early 1967 with intensive air battles, including the shooting down of six Syrian MiG-21 fighter jets over Damascus on 7 April. <span class='highlight-link'>This humiliation and mounting pressure forced</span> King Hussein to sign a mutual defense pact with Egypt's President Nasser in May 1967. <span class='highlight-word'>Ultimately</span>, this military alignment, combined with Nasser's mobilization in Sinai and the blockade of the Straits of Tiran, made a major regional war inevitable, leading directly to the Six Day War in June 1967."
          },
          q3: {
            type: "importance_choice",
            question: "Explain two of the following: (16 marks)",
        ...
        },
        {
          ...
          q2: {
            ...
            model: "<strong>Initially</strong>, the path to negotiations was opened in the aftermath of the 1973 Yom Kippur War, which shattered the myth of Israeli military invincibility and restored Egyptian pride. Recognising that military force alone could not resolve the conflict, US Secretary of State Henry Kissinger intervened to conduct intensive 'shuttle diplomacy' between Jerusalem and Cairo. <span class='highlight-link'>This mediation resulted in</span> the Sinai I (1974) and Sinai II (1975) agreements, separating the armies and reopening the Suez Canal.<br><br><strong>Subsequently</strong>, despite these disengagement agreements, formal peace negotiations remained stalled due to the Arab world's refusal to recognize Israel. To break the diplomatic stalemate, Egyptian President Anwar Sadat took the dramatic step of making an historic visit to Jerusalem in November 1977, where he addressed the Knesset. <span class='highlight-link'>Sadat's visit broke the long-standing political taboo</span> and demonstrated to the Israeli public that Egypt was genuinely committed to peace.<br><br><strong>Finally</strong>, this breakthrough enabled US President Jimmy Carter to invite Sadat and Israeli Prime Minister Menachem Begin to Camp David in September 1978 for a historic summit. After twelve days of intense mediation, they signed the Camp David Accords, establishing a framework for peace. <span class='highlight-link'>This agreement culminated in</span> the official Egypt-Israel Peace Treaty in March 1979, which returned the Sinai Peninsula to Egypt in exchange for diplomatic recognition, <span class='highlight-word'>altering</span> the geopolitical landscape of the Middle East."
          },
          q3: {
            type: "importance_choice",
            question: "Explain two of the following: (16 marks)",
        ...
        },
        {
          ...
          q2: {
            ...
            model: "<strong>Initially</strong>, the war broke out on 6 October 1973 when Egypt and Syria launched a coordinated surprise attack on Israel during the Jewish holy day of Yom Kippur. The Arab forces breached the Bar-Lev Line in the Sinai and advanced across the Golan Heights, aiming to reclaim the occupied territories lost in 1967. <span class='highlight-link'>The initial Arab success caught</span> Israel off guard and threatened its security, prompting an immediate military mobilization.<br><br><strong>Subsequently</strong>, the conflict drew in the superpowers, turning the region into a Cold War proxy struggle. The USA, under President Nixon, launched a massive military airlift (Operation Nickel Grass) to resupply the IDF, while the USSR airlifted military equipment to Egypt and Syria. <span class='highlight-link'>Equipped with American weapons</span>, the IDF launched a successful counter-offensive, crossing the Suez Canal and surrounding the Egyptian Third Army. This escalation brought the USA and USSR to the brink of direct military confrontation.<br><br><strong>Finally</strong>, to avoid a wider war, the superpowers co-sponsored UN Resolution 338 to enforce an immediate ceasefire. <span class='highlight-link'>In the immediate aftermath</span>, Arab nations implemented a devastating OPEC oil embargo against Western countries, quadrupling oil prices and causing a global energy crisis. <span class='highlight-word'>Ultimately</span>, this economic leverage <span class='highlight-word'>forced</span> the United States to actively mediate the peace process, initiating Kissinger's shuttle diplomacy and leading to the disengagement agreements."
          },
          q3: {
            type: "importance_choice",
            question: "Explain two of the following: (16 marks)",
        ...
        },
        {
          ...
          q2: {
            ...
            model: "<strong>Initially</strong>, in the immediate aftermath of the Second World War, the British Mandate in Palestine became increasingly ungovernable due to a violent Jewish insurgency demanding a sovereign state. This campaign of violence reached a climax in July 1946 when the extremist Irgun group bombed the King David Hotel, which housed the British military and administrative headquarters, killing 91 people. <span class='highlight-link'>This devastating attack shattered</span> British political resolve, making the administration of the Mandate too costly and dangerous to maintain.<br><br><strong>Subsequently</strong>, in early 1947, a bankrupt Britain decided to hand the Palestine problem over to the newly formed United Nations. In November 1947, the UN General Assembly passed Resolution 181, which recommended the partition of Palestine into separate Jewish and Arab states, with Jerusalem under international control. <span class='highlight-link'>Although Zionist leaders accepted the plan</span>, Arab leaders furiously rejected it, which immediately triggered a violent civil war between the Jewish and Arab populations.<br><br><strong>Finally</strong>, as British forces completed their withdrawal, David Ben-Gurion declared the official creation of the State of Israel on 14 May 1948. <span class='highlight-link'>The declaration of independence instantly provoked</span> an invasion by five neighbouring Arab armies the very next day. <span class='highlight-word'>Ultimately</span>, this outbreak of conventional war resulted in the displacement of over 700,000 Palestinians (the Nakba) and established Israel's control over 79% of the former Mandate territory, completely redrawing the map of the Middle East."
          },
          q3: {
            type: "importance_choice",
            question: "Explain two of the following: (16 marks)",
  ...
  var LESSONS_DATA = {
    "subtopic_1_1": {
      ...
      "questionVault": [
        ...
        },
        {
          ...
          "answer": "<strong>Model Narrative:</strong> <strong>Initially</strong>, the road to war began in November 1947 when the United Nations passed Resolution 181, recommending the partition of the British Mandate of Palestine into separate Jewish and Arab states. <span class='highlight-link'>While Jewish leaders accepted</span> the plan, the Palestinian Arabs and neighbouring Arab states rejected it, viewing it as an illegal usurpation of their land. <span class='highlight-word'>Consequently</span>, this diplomatic dispute triggered an immediate civil war within Palestine as both communities fought for control of key towns and roads.<br><br><strong>Subsequently</strong>, as the British administration refused to intervene and prepared for its final withdrawal, the civil conflict intensified. Jewish paramilitary forces (the Haganah and Irgun) launched offensive operations to secure the territory allocated by the UN, including capturing key urban centers like Haifa and Jaffa. <span class='highlight-link'>This escalation provoked</span> a severe humanitarian crisis, causing tens of thousands of Palestinian Arabs to flee their homes in fear, while Arab volunteer forces entered Palestine to support the local population.<br><br><strong>Finally</strong>, the conflict escalated into a full-scale international war when the British Mandate officially expired on 14 May 1948, and David Ben-Gurion declared the creation of the State of Israel. <span class='highlight-link'>This declaration instantly provoked</span> an invasion by the regular armies of five neighboring Arab states (Egypt, Syria, Transjordan, Lebanon, and Iraq) the very next day. <span class='highlight-word'>Ultimately</span>, this invasion transformed the local civil conflict into the first Arab-Israeli War, shaping the political borders of the region for decades."
        },
        {
          "question": "Write a narrative account analysing key events leading to the end of the British Mandate, partition and the creation of Israel. (8 marks)",
          "answer": "<strong>Model Narrative:</strong> <strong>Initially</strong>, in the immediate aftermath of the Second World War, the British Mandate in Palestine became increasingly ungovernable due to a violent Jewish insurgency demanding a sovereign state. This campaign of violence reached a climax in July 1946 when the extremist Irgun group bombed the King David Hotel, which housed the British military and administrative headquarters, killing 91 people. <span class='highlight-link'>This devastating attack shattered</span> British political resolve, making the administration of the Mandate too costly and dangerous to maintain.<br><br><strong>Subsequently</strong>, in early 1947, a bankrupt Britain decided to hand the Palestine problem over to the newly formed United Nations. In November 1947, the UN General Assembly passed Resolution 181, which recommended the partition of Palestine into separate Jewish and Arab states, with Jerusalem under international control. <span class='highlight-link'>Although Zionist leaders accepted the plan</span>, Arab leaders furiously rejected it, which immediately triggered a violent civil war between the Jewish and Arab populations.<br><br><strong>Finally</strong>, as British forces completed their withdrawal, David Ben-Gurion declared the official creation of the State of Israel on 14 May 1948. <span class='highlight-link'>The declaration of independence instantly provoked</span> an invasion by five neighbouring Arab armies the very next day. <span class='highlight-word'>Ultimately</span>, this outbreak of conventional war resulted in the displacement of over 700,000 Palestinians (the Nakba) and established Israel's control over 79% of the former Mandate territory, completely redrawing the map of the Middle East.",
    ...
    "subtopic_2_1": {
      ...
      "questionVault": [
        ...
        },
        {
          ...
          "answer": "<strong>Model Narrative:</strong> <strong>Initially</strong>, the crisis began in mid-May 1967 when the Soviet Union provided Egyptian President Gamal Abdel Nasser with false intelligence reports claiming that Israel was massing troops on the Syrian border to launch an invasion. In response to this threat, Nasser mobilized 100,000 Egyptian troops in the Sinai Peninsula and ordered the withdrawal of the United Nations Emergency Force (UNEF) peacekeepers who had acted as a buffer since 1956. <span class='highlight-link'>This mobilization and removal of UN troops</span> created severe security anxiety in Israel, which now faced Egyptian forces directly on its border.<br><br><strong>Subsequently</strong>, Nasser escalated the crisis on 22 May by closing the Straits of Tiran to all Israeli shipping, cutting off Israel's vital southern port of Eilat. Israel had previously declared that a blockade of the Straits would be considered a direct act of war. <span class='highlight-link'>This blockade provoked</span> a diplomatic stalemate, as US-led efforts to organize an international naval coalition to open the waterway failed due to international hesitation, giving Israel the confidence that it had to act independently.<br><br><strong>Finally</strong>, believing that an invasion was imminent, Israel launched a pre-emptive strike on the morning of 5 June 1967, named Operation Focus. The Israeli Air Force destroyed nearly the entire Egyptian air force on the ground in a surprise attack, gaining total air supremacy. <span class='highlight-link'>This devastating strike resulted in</span> the outbreak of the Six Day War, as Israeli ground forces immediately invaded Sinai and Gaza, leading Jordan and Syria to join the conflict."
        },
        {
          "question": "Write a narrative account analysing escalating tension between Israel, Syria and Jordan in the years 1964\u201367. (8 marks)",
          "answer": "<strong>Model Narrative:</strong> <strong>Initially</strong>, tensions began to rise rapidly following the Cairo Conference of 1964, where Arab League leaders approved plans to divert the headwaters of the River Jordan to cut off Israel's water supply. In response, Israel launched air and artillery strikes to destroy the diversion works. <span class='highlight-link'>This water dispute was accompanied by</span> Syria providing active military support and training to Yasser Arafat's Fatah guerrilla group, enabling them to launch cross-border sabotage raids into Israel.<br><br><strong>Subsequently</strong>, the guerrilla raids led to a series of escalating border skirmishes and reprisal actions by the IDF. In November 1966, following a Fatah landmine attack that killed Israeli soldiers, the IDF launched a massive armored raid on the Jordanian-controlled West Bank village of Samu. <span class='highlight-link'>The destruction of Samu resulted in</span> severe humiliation for Jordan's King Hussein, sparking massive anti-government riots among West Bank Palestinians who demanded stronger action against Israel.<br><br><strong>Finally</strong>, the regional escalation peaked in early 1967 with intensive air battles, including the shooting down of six Syrian MiG-21 fighter jets over Damascus on 7 April. <span class='highlight-link'>This humiliation and mounting pressure forced</span> King Hussein to sign a mutual defense pact with Egypt's President Nasser in May 1967. <span class='highlight-word'>Ultimately</span>, this military alignment, combined with Nasser's mobilization in Sinai and the blockade of the Straits of Tiran, made a major regional war inevitable, leading directly to the Six Day War in June 1967.",
          "isHighProbability": true
        }
      ],
      "doNowStarter": {
    ...
    "subtopic_2_3": {
      ...
      "questionVault": [
        ...
        {
          "question": "Write a narrative account analysing key events of the Yom Kippur War (1973) and its aftermath. (8 marks)",
          "answer": "<strong>Model Narrative:</strong> <strong>Initially</strong>, the war broke out on 6 October 1973 when Egypt and Syria launched a coordinated surprise attack on Israel during the Jewish holy day of Yom Kippur. The Arab forces breached the Bar-Lev Line in the Sinai and advanced across the Golan Heights, aiming to reclaim the occupied territories lost in 1967. <span class='highlight-link'>The initial Arab success caught</span> Israel off guard and threatened its security, prompting an immediate military mobilization.<br><br><strong>Subsequently</strong>, the conflict drew in the superpowers, turning the region into a Cold War proxy struggle. The USA, under President Nixon, launched a massive military airlift (Operation Nickel Grass) to resupply the IDF, while the USSR airlifted military equipment to Egypt and Syria. <span class='highlight-link'>Equipped with American weapons</span>, the IDF launched a successful counter-offensive, crossing the Suez Canal and surrounding the Egyptian Third Army. This escalation brought the USA and USSR to the brink of direct military confrontation.<br><br><strong>Finally</strong>, to avoid a wider war, the superpowers co-sponsored UN Resolution 338 to enforce an immediate ceasefire. <span class='highlight-link'>In the immediate aftermath</span>, Arab nations implemented a devastating OPEC oil embargo against Western countries, quadrupling oil prices and causing a global energy crisis. <span class='highlight-word'>Ultimately</span>, this economic leverage <span class='highlight-word'>forced</span> the United States to actively mediate the peace process, initiating Kissinger's shuttle diplomacy and leading to the disengagement agreements.",
          "isHighProbability": true
        }
      ],
      "doNowStarter": {
