      ...
      "steps": [
        ...
        <div class="mastery-media-column">\r
          <div class="map-vector-box" style="padding: 0;">\r
            <img id="map-image-placeholder" class="map-image-display" src="assets/sources/un_partition_plan_1947.png" alt="UN Partition Plan" style="width: 100%; height: 100%; object-fit: contain; display: block; border-radius: var(--border-radius-md);">\r
          </div>\r
